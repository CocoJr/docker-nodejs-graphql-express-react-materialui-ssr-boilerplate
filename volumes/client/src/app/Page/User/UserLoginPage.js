...
import {getFormErrors, setAuthToken} from '../../Util/core';
import {URL_PROFIL, URL_REGISTER} from '../../routes';
...
class UserLoginPage extends React.Component {
    ...
    login(store) {
        if (!store || !store.login || !store.login.token) {
            swal('Impossible de vous connecter');
